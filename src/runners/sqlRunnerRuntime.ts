export type DbConnectionType = 'sqlserver' | 'pgsql' | 'oracle';
...
export function parseSqlOutput(raw: string, type: DbConnectionType): SqlQueryResult {
...
export function parseExplainPlan(output: string, dbType: DbConnectionType): ExplainNode {
